...
function addPackage($id_paket, $nama_paket, $harga_paket, $deskripsi_paket, $gambar_paket)
{
    global $mongo;
...
function deletePackage($id_paket)
{
    ...
    $bulkWrite = new MongoDB\Driver\BulkWrite;
    $bulkWrite->delete(['id_paket' => $id_paket]);
...
if (isset($_POST['submit'])) {
    ...
    addPackage($id_paket, $nama_paket, $harga_paket, $deskripsi_paket, $gambar_paket_path);
}
...
if (isset($_POST['update'])) {
    ...
    $bulkWrite = new MongoDB\Driver\BulkWrite;
    $bulkWrite->update(['id_paket' => $update_id], ['$set' => $update_data]);
            ...
            <tr>
                ...
                <td>
                    <form action="" method="post">
                        <input type="hidden" name="id_paket" value="<?php echo $package->id_paket; ?>">
                        <a href="updatepaket.php?id=<?php echo $package->id_paket; ?>" class="button">Update</a>
