  ...
  <header class="header" data-header>
      ...
      <div class="container">
        ...
        <a href="tel:+01123456790" class="helpline-box">
          ...
          <div class="wrapper">
            ...
            <p class="helpline-number">+6282340571151</p>
          </div>
    ...
    <div class="header-bottom">
      <div class="container">
       ...
       <a href="index2.php"><button class="btn btn-primary">Book Now</button></a> 
    ...
    <article>
      ...
      <section class="hero" id="home">
        <div class="container">
          ...
          <div class="btn-group">
           ...
           <a href="index2.php"><button class="btn btn-secondary">Book now</button></a> 
          </div>
      ...
      <section class="package" id="package">
        <div class="container">
          ...
          <a href="index3.php"><button class="btn btn-primary">View All Packages</button></a>
