  ...
  <header class="header" data-header>
    ...
    <div class="header-top">
      <div class="container">
        ...
        <a href="user_dashboard.php" class="helpline-box">
    ...
    <article>
          ...
          <ul class="popular-list">
            ...
            <li>
              <div class="popular-card">
                ...
                <figure class="card-img">
                  <img src="./assets/images/sunset.jpg" alt="San miguel, italy" loading="lazy">
                </figure>
            ...
            <li>
              <div class="popular-card">
                ...
                <figure class="card-img">
                  <img src="./assets/images/temple.jpg" alt="Burj khalifa, dubai" loading="lazy">
                </figure>
            ...
            <li>
              <div class="popular-card">
                ...
                <figure class="card-img">
                  <img src="./assets/images/snorkling3.jpg" alt="Kyoto temple, japan" loading="lazy">
                </figure>
                ...
                <div class="card-content">
                  ...
                  <h3 class="h3 card-title">
                    <a href="#">Snorkeling with Manta</a>
                  </h3>
      ...
      <section class="package" id="package">
        <div class="container">
          ...
          <a href="datauser.php"><button class="btn btn-primary">View All Packages</button></a>
