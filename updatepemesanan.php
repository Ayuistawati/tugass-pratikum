...
if (isset($_GET['id'])) {
    ...
    echo "            </div>";
    echo "            <div class='form-group'>";
    echo "                <label for='tanggal_keberangkatan'>Tanggal keberangkatan:</label>";
    echo "                <input type='date' name='tanggal_keberangkatan' id='tanggal_keberangkatan' value='" . $row->tanggal_keberangkatan . "' required>";
    echo "            </div>";
    echo "            <div class='form-group'>";
